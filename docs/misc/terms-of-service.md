...
WE DO NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED, SECURE, OR ERROR-FREE. USE OF THE SERVICE IS ENTIRELY AT YOUR OWN RISK.

## 6. Limitation of Liability

TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL THE CREATORS, DEVELOPERS, OR CONTRIBUTORS OF **Markdown-Flashcards** BE LIABLE FOR ANY CLAIM, DAMAGES, OR OTHER LIABILITY, WHETHER IN AN ACTION OF CONTRACT, TORT, OR OTHERWISE, ARISING FROM, OUT OF, OR IN CONNECTION WITH THE SERVICE OR THE USE OR OTHER DEALINGS IN THE SERVICE.
...
We reserve the right to modify these terms at any time. We will do our best to notify users of significant changes, but we recommend reviewing this page periodically. Your continued use of the Service after any changes constitutes your acceptance of the new Terms.
