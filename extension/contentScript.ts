 ...
 */
function extractQuizData(data: NotebookLM_Flashcard | NotebookLM_Quiz): NotebookLM_Quiz {
 ...
 */
function extractFlashcardData(data: NotebookLM_Flashcard | NotebookLM_Quiz): NotebookLM_Flashcard {
